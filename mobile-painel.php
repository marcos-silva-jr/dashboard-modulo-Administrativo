...
<body>
    ...
    <a href="index.php" title="TELA PRINCIPAL"><img src="inicial.png" title="Página Inicial" style="width: 390px; height: 160px; text-align: center;" /></a>
    <label for="logins" style="text-align: center; font-size: 2.5rem;"><br>Selecione a opção:</label>  
	<center>
	...
	<table style="margin-left: 1rem; margin-top: 5rem;"><tr><td>
			...
			<div style="margin-top:0.5rem; display: inline-block;text-align:center; width: 95%; height: 7.4rem; background-color:#042f66;  margin-left: 0.5rem;  border-radius:10px; "><a href='enviarDados-ModuloParceiro.php' style='text-decoration:none; color:white; font-size:2rem; font-weight:bold;'><br>BAIXA WEB - PARCEIRO</a></div>
			
			<!-- =========================================== ********************************** ==============================
			===========================================  DIV BOTÃO BAIXA MOBILE (MÓDULO MOTORISTA) =========================
			=========================================== ********************************======================================-->
			
			<div style=" margin-top:0.5rem;display: inline-block;text-align:center; width: 95%; height: 7.4rem; background-color:#042f66;  margin-left: 0.5rem;  border-radius:10px; "><a href='enviarDados-ModuloParceiro.php' style='text-decoration:none; color:white; font-size:2rem; font-weight:bold;'><br>BAIXA MOBILE - MOTORISTA</a></div>
		...
		<div id="rodape">
			<label style="background-color: #042f66;    text-align: center;    font-weight:normal;    width:100%;
				color:white;     position:fixed;     bottom:0px;    left:0px;     font-size: 1.4rem;    height: 2rem;">
